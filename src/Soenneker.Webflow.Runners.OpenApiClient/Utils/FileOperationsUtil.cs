...
using Soenneker.Webflow.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Webflow.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Webflow:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/webflow/openapi-spec/main/openapi/v2.yml";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Webflow OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "WebflowOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
